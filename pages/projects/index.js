    ...
    <>
      <Layout>
        ...
        <Container>
          ...
          <div
            ref={swiperRef}
            className={`h-screen origin-bottom p-20 text-white transition-all duration-1000 lg:px-60 lg:py-40 ${
              swiperActive ? "swiper" : ""
            }`}
          >
            <div className={`${swiperActive ? "" : "hidden"}`}>
              <div className="fixed left-28 z-50 flex h-screen w-14 items-center justify-center">
                <svg
                  ref={swiperPrevious}
                  viewBox="0 0 61 61"
                  fill="none"
              ...
              <div className="fixed right-28 z-50 flex h-screen w-14 items-center justify-center">
                <svg
                  ref={swiperNext}
                  viewBox="0 0 61 61"
                  fill="none"
            ...
            >
              ...
              >
                <div>
                  <img
                    className={`${swiperActive ? "" : "w-full object-cover"}`}
